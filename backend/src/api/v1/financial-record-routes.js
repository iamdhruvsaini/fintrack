...
router.get("/", authMiddleware, authorize(["admin", "analyst"]), asyncHandler(financialRecordController.getFinancialRecords));
router.get("/:id", authMiddleware,authorize(["admin", "analyst"]), asyncHandler(financialRecordController.getFinancialRecordById));
